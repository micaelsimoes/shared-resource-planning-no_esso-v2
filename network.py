        ...
        for s_m in model.scenarios_market:
            ...
            for s_o in model.scenarios_operation:
                ...
                if params.ess_relax:
                    ...
                    for e in model.shared_energy_storages:
                        for p in model.periods:
                            penalty_ch = PENALTY_RELAXED_MODEL * 1e3 * model.penalty_shared_es_ch[e, s_m, s_o, p]
                            penalty_dch = PENALTY_RELAXED_MODEL * 1e3 * model.penalty_shared_es_ch[e, s_m, s_o, p]
                            penalty_soc = PENALTY_RELAXED_MODEL * model.penalty_shared_es_soc[e, s_m, s_o, p]
                            penalty_comp = PENALTY_RELAXED_MODEL * 1e3 * model.penalty_shared_es_comp[e, s_m, s_o, p]
