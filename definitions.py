...
ERROR_NETWORK_FILE = -2
ERROR_PARAMS_FILE = -3
ERROR_OPERATIONAL_DATA_FILE = -4
ERROR_MARKET_DATA_FILE = -5
...
PENALTY_FLEX_LOAD_ENERGY_BALANCE_CONS = 1e3
PENALTY_ESS_COMPLEMENTARITY = 1e6
PENALTY_ESS_APPARENT_POWER = 1e9
PENALTY_ESS_SOC = 1e6
PENALTY_ESS_DAY_BALANCE = 1e3
PENALTY_ESS_SLACK = 1e6
PENALTY_FLEX = 1e6
PENALTY_INTERFACE_VOLTAGE = 1e3
PENALTY_INTERFACE_POWER_FLOW = 1e3
PENALTY_INTERFACE_ESS = 1e3

PENALTY_RELAXED_MODEL = 10e3
